  ...
  <div className="hero">
    <div className="container">
      <nav className="navbar navbar-expand-lg navbar-dark">
        ...
        <div className="navbar-brand"><img src="https://www.dropbox.com/s/wwe8870bgswddz1/200x100logo_White_Transparent.png?raw=1" target="blank" alt="logo" height="100"></img></div>
